            ...
            {result ? (
                      ...
                      <ul className="space-y-3">
                        {result.top3.map((item, idx) => (
                          <li key={idx} className="space-y-1.5">
                            ...
                            <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden ml-7">
                              <div
                                className={`h-full rounded-full transition-all duration-500 ${
                                  idx === 0
                                    ? isDiseaseDetected
              ...
              <div className="bg-white rounded-2xl p-8 border border-emerald-100">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  leaf image. This will detect any diseases and provide
                  confidence scores.
                </p>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-700">
                    <span className="text-lg">📊</span> Top-3 predictions ranked
                    by confidence
                  </div>
                </div>
              </div>
